...
export default async function HomePage() {
  ...
  if (!page) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center bg-black px-4 text-center">
        <div>
          <h1 className="text-2xl font-bold text-white">Website đang được xây dựng</h1>
          <p className="mt-2 text-white/60">Nội dung trang chủ sẽ sớm được cập nhật.</p>
        </div>
      </div>
    );
  }
